...
export function applyTheme(themeName) {
  ...
  console.log(
    `[Theme] Current data-theme before: "${document.documentElement.getAttribute('data-theme')}"`,
  );
  ...
  console.log(
    `[Theme] Sample values: --bg-primary=${theme.bgPrimary}, --bg-secondary=${theme.bgSecondary}, --text-primary=${theme.textPrimary}`,
  );
  ...
  console.log(
    `[Theme] Computed --bg-secondary: ${getComputedStyle(root).getPropertyValue('--bg-secondary')}`,
  );
}
