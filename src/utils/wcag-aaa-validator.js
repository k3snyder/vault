...
function testChromeLayersContrast() {
  ...
  const chromeLayersLight = [
    ...
    {
      name: 'Content on Secondary BG',
      fg: standardLightText.primary,
      bg: backgrounds.lightSecondary,
    },
    {
      name: 'Secondary Text on Secondary BG',
      fg: standardLightText.secondary,
      bg: backgrounds.lightSecondary,
    },
  ];
  ...
  const chromeLayersDark = [
    ...
    {
      name: 'Content on Secondary BG',
      fg: standardDarkText.primary,
      bg: backgrounds.darkSecondary,
    },
    { name: 'Content on Tertiary BG', fg: standardDarkText.primary, bg: backgrounds.darkTertiary },
    {
      name: 'Secondary Text on Secondary BG',
      fg: standardDarkText.secondary,
      bg: backgrounds.darkSecondary,
    },
  ];
