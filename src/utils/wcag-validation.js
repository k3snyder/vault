...
function testTextColors() {
  ...
  testContrast(
    'textPrimary on bgPrimary',
    lightTheme.textPrimary,
    lightTheme.bgPrimary,
    4.5,
    'light',
  );
  testContrast(
    'textSecondary on bgPrimary',
  ...
  testContrast(
    'textPrimary on bgSecondary',
    lightTheme.textPrimary,
    lightTheme.bgSecondary,
    4.5,
    'light',
  );
  testContrast(
    'textPrimary on bgTertiary',
    lightTheme.textPrimary,
    lightTheme.bgTertiary,
    4.5,
    'light',
  );
  testContrast(
    'textSecondary on bgSecondary',
    lightTheme.textSecondary,
    lightTheme.bgSecondary,
    4.5,
    'light',
...
function testStatusColors() {
  ...
  testContrast(
    'warningText on warningBg',
    lightTheme.warningText,
    lightTheme.warningBg,
    4.5,
    'light',
  );
...
function testPriorityColors() {
  ...
  console.log('LIGHT THEME:');
  testContrast(
    'priority-high text on bg',
    priorities.light.high.text,
    priorities.light.high.bg,
    4.5,
    'light',
  );
  testContrast(
    'priority-medium text on bg',
    priorities.light.medium.text,
    priorities.light.medium.bg,
    4.5,
    'light',
  );
  testContrast(
    'priority-low text on bg',
    priorities.light.low.text,
    priorities.light.low.bg,
    4.5,
    'light',
  );
  ...
  console.log('\nDARK THEME:');
  testContrast(
    'priority-high text on dark bg',
    priorities.dark.high.text,
    darkTheme.bgPrimary,
    4.5,
    'dark',
  );
  testContrast(
    'priority-medium text on dark bg',
    priorities.dark.medium.text,
    darkTheme.bgPrimary,
    4.5,
    'dark',
  );
  testContrast(
    'priority-low text on dark bg',
    priorities.dark.low.text,
    darkTheme.bgPrimary,
    4.5,
    'dark',
  );
...
function testAccentColors() {
  ...
  testContrast(
    'wikilinkValid on bgPrimary',
    lightTheme.wikilinkValid,
    lightTheme.bgPrimary,
    3.0,
    'light',
  );
  testContrast(
    'wikilinkBroken on bgPrimary',
    lightTheme.wikilinkBroken,
    lightTheme.bgPrimary,
    3.0,
    'light',
  );
...
function testFocusIndicators() {
  ...
  testContrast(
    'borderFocus on bgPrimary',
    lightTheme.borderFocus,
    lightTheme.bgPrimary,
    3.0,
    'light',
  );
...
function testEditorColors() {
  ...
  testContrast(
    'editorLineNumber on editorBg',
    lightTheme.editorLineNumber,
    lightTheme.editorBg,
    4.5,
    'light',
  );
  testContrast(
    'editorLineNumberActive on editorBg',
    lightTheme.editorLineNumberActive,
    lightTheme.editorBg,
    4.5,
    'light',
  );
  ...
  testContrast(
    'editorLineNumberActive on editorBg',
    darkTheme.editorLineNumberActive,
    darkTheme.editorBg,
    4.5,
    'dark',
  );
...
function testSyntaxColors() {
  ...
  console.log('LIGHT THEME:');
  testContrast(
    'syntaxKeyword on editorBg',
    lightTheme.syntaxKeyword,
    lightTheme.editorBg,
    3.0,
    'light',
  );
  testContrast(
    'syntaxString on editorBg',
    lightTheme.syntaxString,
    lightTheme.editorBg,
    3.0,
    'light',
  );
  testContrast(
    'syntaxComment on editorBg',
    lightTheme.syntaxComment,
    lightTheme.editorBg,
    3.0,
    'light',
  );
  testContrast(
    'syntaxFunction on editorBg',
    lightTheme.syntaxFunction,
    lightTheme.editorBg,
    3.0,
    'light',
  );
...
function generateReport() {
  ...
  const textTests = validationResults.passed.filter(
    (t) => t.label.includes('text') || t.label.includes('Text'),
  );
  const accentTests = validationResults.passed.filter(
    (t) => t.label.includes('accent') || t.label.includes('link'),
  );
  const statusTests = validationResults.passed.filter(
    (t) =>
      t.label.includes('success') ||
      t.label.includes('warning') ||
      t.label.includes('error') ||
      t.label.includes('info'),
  );
...
export function documentContrastRatios() {
  ...
  documentation.lightTheme = {
    text: {
      ...
      'textSecondary on bgPrimary': getContrastRatio(
        lightTheme.textSecondary,
        lightTheme.bgPrimary,
      ),
    ...
    accents: {
      'accentPrimary on bgPrimary': getContrastRatio(
        lightTheme.accentPrimary,
        lightTheme.bgPrimary,
      ),
