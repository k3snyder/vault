...
export function PluginPermissionDialog({ request, onResponse }: PluginPermissionDialogProps) {
  ...
  const getCapabilityIcon = () => {
    if (
      request.capability.startsWith('vault:write') ||
    ...
    <Dialog open={!!request}>
      <DialogContent className="sm:max-w-[500px]">
        ...
        <DialogFooter className="flex-col sm:flex-row gap-2">
          ...
          <Button variant="secondary" onClick={handleGrantOnce} className="w-full sm:w-auto">
            Allow This Time
          </Button>
          <Button
            variant="default"
