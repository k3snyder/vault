...
export class TagContextExpander {
  ...
  async getTagBasedContext(message, currentContext) {
    ...
    try {
      ...
      const newContextNotes = taggedNotes.filter((note) => !currentNotePaths.has(note.file));
