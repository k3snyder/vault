    ...
    try {
      ...
      if (isAuthenticated) {
        ...
        authWrapper.innerHTML = `
          ...
          <button class="chat-auth-check-btn" type="button" data-action="recheck-claude-auth">
        ...
        const recheckBtn = authWrapper.querySelector('[data-action="recheck-claude-auth"]');
        if (recheckBtn) {
