        ...
        permissions: [
          {
            ...
            name: 'Read Files',
            risk: 'medium',
            description: 'Read files from your vault',
          },
          {
            id: 'filesystem.write',
            name: 'Write Files',
            risk: 'high',
            description: 'Create and modify files in your vault',
          },
          {
            id: 'filesystem.delete',
            name: 'Delete Files',
            risk: 'high',
            description: 'Delete files from your vault',
          },
        ],
      },
      network: {
      ...
      vault: {
        ...
        permissions: [
          ...
          },
          {
            ...
            name: 'Vault Settings',
            risk: 'high',
            description: 'Modify vault configuration',
          },
        ],
      },
      system: {
    ...
    return `
            <div class="permission-matrix">
                ...
                <div class="permission-categories">
                    ${Object.entries(this.permissionCategories)
                      .map(
                        ([categoryId, category]) => `
  ...
  findPermissionIssues() {
    ...
    this.context.state.installedPlugins.forEach((plugin) => {
      ...
      if (permissions.length > 10) {
        issues.push(
          `${plugin.name} has an unusually high number of permissions (${permissions.length})`,
        );
      }
    });
