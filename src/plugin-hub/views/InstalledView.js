...
class InstalledView {
  ...
  updateStats() {
    ...
    if (stats) {
      stats.querySelector('.stat-item:nth-child(1) .stat-value').textContent =
        this.getTotalPlugins();
      stats.querySelector('.stat-item:nth-child(2) .stat-value').textContent =
        this.getEnabledCount();
      stats.querySelector('.stat-item:nth-child(3) .stat-value').textContent =
        this.getDisabledCount();
      stats.querySelector('.stat-item:nth-child(4) .stat-value').textContent =
        this.getUpdateCount();
    }
  }
