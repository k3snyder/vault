...
import { createAndOpenFile, openFile } from '../app/file-open.js';
...
export class CalendarWidget {
  ...
  async handleDayClick(date) {
    ...
    if (noteInfo && noteInfo.exists) {
      ...
      createAndOpenFile(dailyNotePath, template);
  ...
  async openSettings() {
    ...
    header
      .querySelector('.calendar-settings-close')
