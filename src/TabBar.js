...
export class TabBar {
  ...
  getTabIcon(tab) {
    switch (tab.type) {
      ...
      case 'boxnote':
        return icons.fileLock({ size: 14 });
      case 'html':
        return icons.eye({ size: 14 });
      case 'pdf':
